<header class="header-style-1"> 
  ...
  <li><a href="{{route('login')}}"><i class="icon fa fa-lock"></i>
    @if(session()->get('language') == 'hindi') लॉग इन करें @else Login @endif
  </a></li>
            @endauth
          </ul>
        </div>
...
<!-- sub category  -->
@php
$subcategories = App\Models\SubCategory::where('category_id',$cat_values->id)->OrderBy('subcategory_name_en','ASC')->get();
@endphp
